...
const GetStarted = () => {
  return (
    <div>
        <div className="ml-4">
            <h4 className="text-lg font-medium leading-6">Launch</h4>
            <p className="mt-2 dark:text-gray-500">We will help you manage the launch of your collection, from creating your mining site, whitelist, public sale, and more.</p>
