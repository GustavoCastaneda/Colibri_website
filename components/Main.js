...
export default function Main()  {
  ...
  return (
    <div>
            <section className='flex lg:flex-row flex-col sm:py-16 py-6 z-5'>
                ...
                className=' flex-1 flex justify-center items-start flex-col xl:px-13 sm:px-16 px-6'>
                    ...
                    <div>
                        <motion.p variants={ textVariant(1.2)} className="text-center md:text-center w-full mb-6 text-gray-500 lg:mb-8 md:text-lg lg:text-2xl font-bold pt-10">
                            We specialize in web3 development services and blockchain-related solutions, delivering tailor-made software and projects for businesses.
                            </motion.p>
                        ...
                        <motion.div variants={ navVariants }
                            ...
                            <a rel="noopener noreferrer" href="#" className="text-white w-full bg-gradient-to-br from-blue-500 to-blue-700 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none font-medium rounded-lg text-gl px-10 py-5 text-center mr-2 mb-2 ">Get Started</a>
                            <a rel="noopener noreferrer" href="#" className="flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-100 px-8 py-3 text-base font-medium text-indigo-700 hover:bg-indigo-200 md:py-4 md:px-10 md:text-lg">About us</a>
                        </motion.div>    
                    </div>
                </motion.div>
                <motion.div
