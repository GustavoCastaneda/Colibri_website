                ...
                className=' flex-1 flex justify-center items-start flex-col xl:px-13 sm:px-16 px-6'>
                    ...
                    <div>
                        <motion.p variants={ textVariant(1.2)} className="text-center md:text-center w-full mb-6 text-gray-500 lg:mb-8 md:text-lg lg:text-2xl font-bold pt-10">
                            ...
                            <a rel="noopener noreferrer" href="/contact.html" className="text-white w-full bg-gradient-to-br from-blue-500 to-blue-700 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none font-medium rounded-lg text-gl px-10 py-5 text-center mr-2 mb-2 ">Get Started</a>
