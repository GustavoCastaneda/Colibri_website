...
<footer className="p-4 bg-white sm:p-6">
    <div className="md:flex md:justify-between pt-10">
        <div className="mb-6 md:mb-0">
            <a href="https://flowbite.com/" className="flex items-center">
                <Image src={Logo} className="mr-3  w-[150px]" alt="FlowBite Logo" />
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com/" className="hover:underline">Colibri™</a>. All Rights Reserved.
        </span>
